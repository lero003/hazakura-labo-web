(function () {
    ...
    const revealSelectors = '.philosophy-card, .vision-card, .layer-card, .research-log-card, .cycle-bridge-card, .quote-prelude-card, .section-title, .project-card, .book-showcase, .quote-block';
